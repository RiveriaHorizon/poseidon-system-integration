...
class MPU9250_
{
    ...
    float magBias[3] = {605.78, 81.18, -126.99};
    float magScale[3]  = {0.90, 1.11, 1.01}; // Bias corrections for gyro and accelerometer

    float gyroBias[3] = {-3.60, 0.33, -0.74}; // bias corrections
    float accelBias[3] = {0.14612, 0.06750, -0.15100}; // bias corrections
