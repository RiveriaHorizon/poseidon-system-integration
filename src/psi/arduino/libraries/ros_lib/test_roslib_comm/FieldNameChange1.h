#ifndef _ROS_test_roslib_comm_FieldNameChange1_h
#define _ROS_test_roslib_comm_FieldNameChange1_h
...
namespace test_roslib_comm
{
  ...
  class FieldNameChange1 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "test_roslib_comm/FieldNameChange1"; };
