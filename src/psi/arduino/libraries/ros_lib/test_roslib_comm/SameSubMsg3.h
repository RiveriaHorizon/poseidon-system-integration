#ifndef _ROS_test_roslib_comm_SameSubMsg3_h
#define _ROS_test_roslib_comm_SameSubMsg3_h
...
namespace test_roslib_comm
{
  ...
  class SameSubMsg3 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "test_roslib_comm/SameSubMsg3"; };
