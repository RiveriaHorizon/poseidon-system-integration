#ifndef _ROS_test_roslib_comm_SameSubMsg2_h
#define _ROS_test_roslib_comm_SameSubMsg2_h
...
namespace test_roslib_comm
{
  ...
  class SameSubMsg2 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "test_roslib_comm/SameSubMsg2"; };
