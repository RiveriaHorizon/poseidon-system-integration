#ifndef _ROS_test_roslib_comm_TypeNameChangeComplex1_h
#define _ROS_test_roslib_comm_TypeNameChangeComplex1_h
...
namespace test_roslib_comm
{
  ...
  class TypeNameChangeComplex1 : public ros::Msg
  {
    public:
      uint32_t a_length;
      ...
      _a_type st_a;
      _a_type * a;
      test_roslib_comm::SameSubMsg2 b[10];
    ...
    const char * getType(){ return "test_roslib_comm/TypeNameChangeComplex1"; };
