#ifndef _ROS_test_roslib_comm_TypeNameChangeArray2_h
#define _ROS_test_roslib_comm_TypeNameChangeArray2_h
...
namespace test_roslib_comm
{
  ...
  class TypeNameChangeArray2 : public ros::Msg
  {
    public:
      uint32_t a_length;
    ...
    const char * getType(){ return "test_roslib_comm/TypeNameChangeArray2"; };
